...
public class GpsTracker extends Service implements LocationListener {
    ...
    public void getLocation() {
        ...
        try {
            ...
            user.put("TIME", df.format(dateobj));

            FirebaseFirestore db = FirebaseFirestore.getInstance();
            FirebaseDatabase mDatabase = FirebaseDatabase.getInstance();
            DatabaseReference mDbRef = mDatabase.getReference("Coordinates");
            String userId = mDbRef.push().getKey();
            coordinates coordinates = new coordinates(location.getLatitude(), location.getLongitude(),df.format(dateobj));
            mDbRef.child(userId).setValue(coordinates);
            ...
            db.collection("users")
                    ...
                    .addOnSuccessListener(new OnSuccessListener<DocumentReference>() {
                        ...
                        public void onSuccess(DocumentReference documentReference) {
                            Log.d(TAG, df.format(dateobj) + documentReference.getId());
